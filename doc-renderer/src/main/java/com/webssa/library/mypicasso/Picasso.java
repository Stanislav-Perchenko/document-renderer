 ...
 */
package com.webssa.library.mypicasso;
...
import static com.webssa.library.mypicasso.Dispatcher.HUNTER_BATCH_COMPLETE;
import static com.webssa.library.mypicasso.Dispatcher.REQUEST_BATCH_RESUME;
import static com.webssa.library.mypicasso.Dispatcher.REQUEST_GCED;
import static com.webssa.library.mypicasso.MemoryPolicy.shouldReadFromMemoryCache;
import static com.webssa.library.mypicasso.Picasso.LoadedFrom.MEMORY;
import static com.webssa.library.mypicasso.Utils.OWNER_MAIN;
import static com.webssa.library.mypicasso.Utils.THREAD_LEAK_CLEANING_MS;
import static com.webssa.library.mypicasso.Utils.THREAD_PREFIX;
import static com.webssa.library.mypicasso.Utils.VERB_CANCELED;
import static com.webssa.library.mypicasso.Utils.VERB_COMPLETED;
import static com.webssa.library.mypicasso.Utils.VERB_ERRORED;
import static com.webssa.library.mypicasso.Utils.VERB_RESUMED;
import static com.webssa.library.mypicasso.Utils.checkMain;
import static com.webssa.library.mypicasso.Utils.log;
...
public class Picasso {
  ...
  Picasso(Context context, Dispatcher dispatcher, Cache cache, Listener listener, RequestTransformer requestTransformer, List<RequestHandler> extraRequestHandlers, Stats stats, Bitmap.Config defaultBitmapConfig, boolean loggingEnabled) {
    ...
    @Override public void run() {
      ...
      while (true) {
        try {
          ...
          Action.RequestWeakReference<?> remove = (Action.RequestWeakReference<?>) referenceQueue.remove(THREAD_LEAK_CLEANING_MS);
  ...
  public static class Builder {
    ...
    public Picasso build() {
      ...
      return new Picasso(context, dispatcher, cache, listener, transformer, requestHandlers, stats, defaultBitmapConfig, loggingEnabled);
    }
  }
